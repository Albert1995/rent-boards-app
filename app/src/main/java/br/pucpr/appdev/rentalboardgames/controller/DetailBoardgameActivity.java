...
public class DetailBoardgameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final User user = ((CustomApplication) this.getApplication()).getUser();
        ...
        db.collection("boardgames")
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                btnRent.setVisibility(boardgame.isAvalibleToRent() && !user.isLendingBoardgame(boardgame) && user.hasLending() ? View.VISIBLE : View.GONE);
