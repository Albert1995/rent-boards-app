...
import br.pucpr.appdev.rentalboardgames.controller.SignUpActivity;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appContext = (CustomApplication) this.getApplication();
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> implements OnCompleteListener<AuthResult> {
        ...
        protected Boolean doInBackground(Void... params) {
            if (mEmail != null && mPassword != null)
                fbAuth.signInWithEmailAndPassword(mEmail, mPassword).addOnCompleteListener(this);
                ...
                db.collection("users").document(fbUser.getUid()).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(LoginActivity.this, ListBoardgames.class);
                            startActivity(i);
